...
export class API {
     ...
     */
    async getStatuses(accountID, queryParameters) {
     ...
     * Promise with the array of statuses, if successful.
     */
    async getStatusesOfFollowing(queryParameters) {
     ...
     * Promise with the array of statuses, if successful.
     */
    async getStatusesOfList(listID, queryParameters) {
     ...
     * Promise with the array of statuses, if successful.
     */
    async getStatusesOfTag(tag, queryParameters) {
     ...
     * Promise with the array of statuses, if successful.
     */
    async getStatusesOfTimeline(queryParameters) {
